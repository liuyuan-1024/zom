//! 编辑器历史栈（Undo/Redo）与历史录入策略。

use std::time::{Duration, Instant};

use crate::features::editing::state::EditorState;
use zom_protocol::{EditorAction, EditorInvocation, FindReplaceAction};
...
pub fn should_record_history(command: &EditorInvocation) -> bool {
    match command {
