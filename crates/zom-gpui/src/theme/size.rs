...
/// 6.0px (极小间距/微调)。
pub(crate) const GAP_1: f32 = 6.0;
/// 9.0px (紧凑图标簇间距)。
pub(crate) const GAP_1_5: f32 = GAP_1 * 1.5;
/// 12.0px (组件内容间距)。
pub(crate) const GAP_2: f32 = GAP_1 * 2.0;
/// 18.0px (段落/区块间距)。
pub(crate) const GAP_3: f32 = GAP_1 * 3.0;

/// 小尺寸内边距 (如只读查看区内边距)。
pub(crate) const PADDING_SM: f32 = 8.0;
...
/// 微型按钮热区 (如 Tab 关闭按钮的容器)。
pub(crate) const CONTROL_XS: f32 = 16.0;
/// 中尺寸行号/序号栏宽度。
pub(crate) const GUTTER_MD: f32 = 40.0;
