...
impl AppIcon {
    pub(crate) const fn asset_path(self) -> &'static str {
        match self {
            ...
            AppIcon::FileTree => "icons/tool_bar/file_tree.svg",
            AppIcon::GitBranchAlt => "icons/tool_bar/git_branch_alt.svg",
            AppIcon::ListTree => "icons/tool_bar/list_tree.svg",
            AppIcon::Search => "icons/tool_bar/search.svg",
            AppIcon::BoltOutlined => "icons/tool_bar/bolt_outlined.svg",
            AppIcon::Check => "icons/status_bar/check.svg",
            AppIcon::Terminal => "icons/tool_bar/terminal.svg",
            AppIcon::Debug => "icons/tool_bar/debug.svg",
            AppIcon::Notification => "icons/tool_bar/notification.svg",
